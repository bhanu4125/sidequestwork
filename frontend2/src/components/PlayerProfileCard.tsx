...
export default function PlayerProfileCard({
  ...
  return (
    <div className={`w-full rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-all dark:border-[#282828] dark:bg-[#1c1c1c] dark:shadow-none ${className}`}>
      {/* Header Profile Info */}
      ...
      <p className="mt-3 text-xs leading-relaxed text-slate-600 dark:text-zinc-400">
        {bio ? bio : <span className="italic text-slate-400 dark:text-zinc-500">No bio added yet.</span>}
      </p>
