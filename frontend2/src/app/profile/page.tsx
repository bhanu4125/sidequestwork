...
export default function ProfilePage() {
  ...
  const filteredAchievements = useMemo(() => {
    if (selectedRarity === "all") return mockAchievements;
    return mockAchievements.filter((badge) => badge.rarity === selectedRarity);
  }, [selectedRarity]);

  const filteredCampusBadges = useMemo(() => {
    if (selectedRarity === "all") return mockCampusBadges;
    return mockCampusBadges.filter((badge) => badge.rarity === selectedRarity);
  }, [selectedRarity]);
          ...
          <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
              ...
              <div className="mb-6 flex flex-wrap items-center gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-[#282828] dark:bg-[#1c1c1c]">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    const isActive = selectedRarity === filter.value;
                    return (
                      <button
                        key={filter.value}
                        type="button"
            ...
            <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
              <div className="space-y-6 flex flex-col justify-between h-full">
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm dark:border-[#282828] dark:bg-[#1c1c1c] flex-1 flex flex-col justify-between mb-1">
                  <div>
